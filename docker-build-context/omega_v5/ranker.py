...
class CrossPoolSpread:
    ...
    predicted_success_prob: Decimal = Decimal("0")  # New field for ML model output
    expected_value_pct: Decimal = Decimal("0")      # New field for ranking
    cross_protocol: bool = False
    cross_invariant: bool = False
